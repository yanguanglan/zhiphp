...
;(function($){
    $.ZhiPHP.item = {
        ...
        init: function(options){
            options && $.extend($.ZhiPHP.item.settings, options);
            var s = $.ZhiPHP.item.settings;
            //单个
            ...
            $.ZhiPHP.item.share();
            $.ZhiPHP.item.select_album();
            $.ZhiPHP.item.joinalbum();
            $.ZhiPHP.item.like();
            $.ZhiPHP.item.unlike();
            $.ZhiPHP.item.del();
            $.ZhiPHP.item.gallery();
        ...
        fetch: function(result){
            ...
            $.ZhiPHP.item.fetch_form($('#J_fetch_item'), result.item);
        },
